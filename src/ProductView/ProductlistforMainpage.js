...
export default function ProductListforMainpage(){
    ...
    const handleSearch=(evt)=>{
        ...
        axios.get(url).then(res=> setPlist(res.data.filter(product=>product.status===true))).catch(err=> toast.error(err));
    };
        ...
        return(
            ...
            <div className={showlogin?"blured-content":""}>
                <div className="customer-info">
                    {customerSession?(
                       ...
                       <span><h4>Customer: Guest</h4></span> 
                    )}
                </div>
                <>
               <div>
          ...
          <span className="cart-icon">🛒</span>
                    ...
                    <div className="mainpage_filter-container">
                        ...
                        <label className="SelectFirst">Search By Category</label>
